...
public partial class TimelineViewModel : ObservableObject
{
    ...
    [RelayCommand]
    public async Task ZoomInAsync(CancellationToken ct = default)
    {
        try
        {
    ...
    [RelayCommand]
    public async Task ZoomOutAsync(CancellationToken ct = default)
    {
        try
        {
            ct.ThrowIfCancellationRequested();
    ...
    public double GetTaskXPosition(ExecutionTaskDisplay task)
    {
        ...
        return (taskOffset / duration) * 100.0;
    }
    ...
    public double GetTaskWidth(ExecutionTaskDisplay task)
    {
        ...
        return (taskDuration / duration) * 100.0;
    }
}
